  ...
  <!-- ================ contact section start ================= -->
   ...
   <h1>
	...
	<form action="<%=request.getContextPath()%>/customer/updatePasswordAction.jsp" method="post">
					...
					변경할 비밀번호<input type="password" name="pw" placeholder="비밀번호" required="required" class="single-input"><br>

					변경할 비밀번호 확인<input type="password" name="checkPw" placeholder="비밀번호 재확인" required="required" class="single-input"><br>
		
			<button type="submit" class="genric-btn primary-border circle">비밀번호 변경</button>
		</form>
